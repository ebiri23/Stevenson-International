const libraryNav = `<nav class="navbar navbar-expand-lg bg-body-tertiary">
          <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
              ...
              <li class="nav-item">
                <a class="nav-link" onclick="libraryStudy()" style="cursor: pointer;">Study</a>
            </li>
              </ul>
...
function libraryStudy(){
  document.body.innerHTML = `${libraryNav}<br><br>
                                                      <div>
                                                        <marquee behavior="slide" scrollamount="80" loop="1" direction="down">
                                                        <div style="background-color: rgb(137, 247, 247); border: 1px solid rgb(1, 248, 248); padding: 15px; border-radius: 30px;">
                                                        <h3 style="text-align: center;">
                                                        
                                                            <a id="option-library" onclick="studyAccountancy()">Accountancy (Financial Accounting)</a>
                                                         
                                                        </h3>
                                                        <h3 id="option-library" style="text-align: center;">
                                                         
                                                          <a id="option-library" onclick="studyCybersecurity()">Cybersecurity</a>
                                                        
                                                      </h3> 
                                                      <h3 id="option-library" style="text-align: center;">
                                                         
                                                          <a id="option-library" onclick="studyDataAnalyst()">Data Analyst</a>
                                                        
                                                      </h3> 
                                                        <h3 id="option-library" style="text-align: center;">
                                                        
                                                          <a id="option-library" onclick="studyDevelopment()">Development</a>
                                                        
                                                         </h3>
                                                        <h3 id="option-library" style="text-align: center;">
                                                       
                                                          <a id="option-library" onclick="studyDigitalMarketing()">Digital Marketing</a>
                                                        
                                                        </h3>
                                                        <h3 id="option-library" style="text-align: center;">
                                                        
                                                          <a id="option-library" onclick="studyEnglish()">English</a>
                                                        
                                                        </h3>
                                                        <h3 id="option-library" style="text-align: center;">
                                                        
                                                            <a id="option-library" onclick="studyMachineLearning()">Machine Learning</a>
                                                          
                                                        </h3>
                                                        <h3 id="option-library" style="text-align: center;">
                                                        
                                                        <a id="option-library" onclick="studyProjectManagement()">Project Management</a>
...
function studyAccountancy() {
  document.body.innerHTML = `${libraryNav}<br><br>
  <div>
  <h3 style="text-align: center;">Accountancy</h3>
  <br><br>
  <div class="row" style="margin: 0px; padding: 0px;">
    ...
    <iframe width="100%" height="350" src="https://www.youtube.com/embed/v-djL7SPw4c?si=qLYTamfhwIklLDNl" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>  <br><br>
   <button  onclick="accountancyQA()" style="float: right;">Next</button>
</div>
<div class="col-md-3 col-lg-3" style="margin: 0px; padding: 0px;"></div>
</div>
</div>`
};
function studyCybersecurity() {
  document.body.innerHTML = `${libraryNav}<br><br><div>
  <h3 style="text-align: center;">Cybersecurity</h3>
  <br><br>
  <div class="row" style="margin: 0px; padding: 0px;">
    <div class="col-md-3 col-lg-3" style="margin: 0px; padding: 0px;"></div>
    <div class="col-md-12 col-lg-6" style="margin: 0px; padding: 0px;">
    <iframe width="100%" height="350" src="https://www.youtube.com/embed/s19BxFpoSd0?si=lRLiBSSCsN4_kQlA" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>  <br><br>
   <button  onclick="cybersecurityQA()" style="float: right;">Next</button>
</div>
<div class="col-md-3 col-lg-3" style="margin: 0px; padding: 0px;"></div>
</div>
</div>`
};
function studyDataAnalyst() {
  document.body.innerHTML = `${libraryNav}<br><br><div>
  <h3 style="text-align: center;">Data Analyst</h3>
  <br><br>
  <div class="row" style="margin: 0px; padding: 0px;">
    <div class="col-md-3 col-lg-3" style="margin: 0px; padding: 0px;"></div>
    <div class="col-md-12 col-lg-6" style="margin: 0px; padding: 0px;">
    <iframe width="100%" height="350" src="https://www.youtube.com/embed/RX0ehXijbSk?si=Z7XMejlrZXa2GzIK" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>  <br><br>
   <button  onclick="dataAnalystQA()" style="float: right;">Next</button>
</div>
<div class="col-md-3 col-lg-3" style="margin: 0px; padding: 0px;"></div>
</div>
</div>`
};
function studyDevelopment() {
  document.body.innerHTML = `${libraryNav}<br><br><div>
  ...
  <div class="row" style="margin: 0px; padding: 0px;">
    <div class="col-md-3 col-lg-3" style="margin: 0px; padding: 0px;"></div>
    <div class="col-md-12 col-lg-6" style="margin: 0px; padding: 0px;">
    <iframe width="100%" height="350" src="https://www.youtube.com/embed/HVjjoMvutj4?si=J70Pj3g95KigvOwW" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>  <br><br>
   <button  onclick="developmentQA()" style="float: right;">Next</button>
</div>
<div class="col-md-3 col-lg-3" style="margin: 0px; padding: 0px;"></div>
</div>
</div>`
};
function studyDigitalMarketing() {
  document.body.innerHTML = `${libraryNav}<br><br><div>
  ...
  <div class="row" style="margin: 0px; padding: 0px;">
    <div class="col-md-3 col-lg-3" style="margin: 0px; padding: 0px;"></div>
    <div class="col-md-12 col-lg-6" style="margin: 0px; padding: 0px;">
    <iframe width="100%" height="350" src="https://www.youtube.com/embed/01Imoibt4as?si=TlFRZHo_txRdQ_f2" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>  <br><br>
   <button  onclick="digitalMarketingQA()" style="float: right;">Next</button>
</div>
<div class="col-md-3 col-lg-3" style="margin: 0px; padding: 0px;"></div>
</div>
</div>`
...
function studyEnglish() {
  ...
  <div class="row" style="margin: 0px; padding: 0px;">
    <div class="col-md-3 col-lg-3" style="margin: 0px; padding: 0px;"></div>
    <div class="col-md-12 col-lg-6" style="margin: 0px; padding: 0px;">
    <iframe width="100%" height="350" src="https://www.youtube.com/embed/h-sw2dlq5zM?si=4fp0jPdPt9fcst10" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>  <br><br>
   <button  onclick="englishQA()" style="float: right;">Next</button>
</div>
<div class="col-md-3 col-lg-3" style="margin: 0px; padding: 0px;"></div>
</div>
</div>`
};
function studyMachineLearning() {
  document.body.innerHTML = `${libraryNav}<br><br><div>
  ...
  <div class="row" style="margin: 0px; padding: 0px;">
    <div class="col-md-3 col-lg-3" style="margin: 0px; padding: 0px;"></div>
    <div class="col-md-12 col-lg-6" style="margin: 0px; padding: 0px;">
    <iframe width="100%" height="350" src="https://www.youtube.com/embed/i_LwzRVP7bg?si=OYgh0Trr-OpXBEdM" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>  <br><br>
   <button  onclick="machineLearningQA()" style="float: right;">Next</button>
</div>
<div class="col-md-3 col-lg-3" style="margin: 0px; padding: 0px;"></div>
</div>
</div>`
};
function studyProjectManagement() {
  document.body.innerHTML = `${libraryNav}<br><br><div>
  ...
  <div class="row" style="margin: 0px; padding: 0px;">
    <div class="col-md-3 col-lg-3" style="margin: 0px; padding: 0px;"></div>
    <div class="col-md-12 col-lg-6" style="margin: 0px; padding: 0px;">
    <iframe width="100%" height="350" src="https://www.youtube.com/embed/vzqDTSZOTic?si=7NKwWivFX7muVmzB" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>   
    <button  onclick="projectManagementQA()" style="float: right;">Next</button>
</div>
<div class="col-md-3 col-lg-3" style="margin: 0px; padding: 0px;"></div>
</div>
</div>`
...
function accountancyQA() {
  document.body.innerHTML = `${libraryNav}<br><br><div style="background-color: white; padding: 30px; border-radius: 30px;><div>
  <h3 style="text-align: center;">If you have the answer consider yourself to have 80% knowlegde on the subject.</h3>
  <br><br>
  <div class="row" style="margin: 0px; padding: 0px;">
    <div class="col-md-3 col-lg-3" style="margin: 0px; padding: 0px;"></div>
    <div class="col-md-12 col-lg-6" style="margin: 0px; padding: 0px;">
        <label><b>1)How many financial statements exist? Can you prepare them?  2)The accounting equation is Assets = Liabilities - Owners Equity, what is assets? Is a prepaid expense an asset or a liabilitie?</b></label>
        <textarea style="text-align: center; background-color: rgb(222, 236, 169); width: 90%; height: 300px;" id="comment" type="comment"  name="comment" placeholder="Your answer, additional research may be required on the subject..." required></textarea> 
       <br><br>
  <button  onclick="studyAccountancy()" style="float: left;">Previous</button><button onclick="libraryStudy()" style="float: right;">Complete</button>
</div>
<div class="col-md-3 col-lg-3" style="margin: 0px; padding: 0px;"></div>
</div>
</div></div>`
};
function cybersecurityQA() {
  document.body.innerHTML = `${libraryNav}<br><br><div style="background-color: white; padding: 30px; border-radius: 30px;><div>
  <h3 style="text-align: center;">If you have the answer consider yourself to have 80% knowlegde on the subject.</h3>
  <br><br>
  <div class="row" style="margin: 0px; padding: 0px;">
    <div class="col-md-3 col-lg-3" style="margin: 0px; padding: 0px;"></div>
    <div class="col-md-12 col-lg-6" style="margin: 0px; padding: 0px;">
        <label><b>1) What is metadata, botnet, zombie? 2)What is a three-way handshake? What is the difference between IDS and IPS? What are the response codes that can be received from a Web Application?</b></label>
        <textarea style="text-align: center; background-color: rgb(222, 236, 169); width: 90%; height: 300px;" id="comment" type="comment"  name="comment" placeholder="Your answer, additional research may be required on the subject..." required></textarea> 
       <br><br>
  <button  onclick="studyCybersecurity()" style="float: left;">Previous</button><button onclick="libraryStudy()" style="float: right;">Complete</button>
</div>
<div class="col-md-3 col-lg-3" style="margin: 0px; padding: 0px;"></div>
</div>
</div></div>`
};
function dataAnalystQA() {
  document.body.innerHTML = `${libraryNav}<br><br><div style="background-color: white; padding: 30px; border-radius: 30px;><div>
  <h3 style="text-align: center;">If you have the answer consider yourself to have 80% knowlegde on the subject.</h3>
  <br><br>
  <div class="row" style="margin: 0px; padding: 0px;">
    <div class="col-md-3 col-lg-3" style="margin: 0px; padding: 0px;"></div>
    <div class="col-md-12 col-lg-6" style="margin: 0px; padding: 0px;">
        <label><b>1. Mention the differences between Data Mining and Data Profiling? 2)Which are the technical tools that you have used for analysis and presentation purposes? What is the significance of Exploratory Data Analysis (EDA)? Meaning of the the term 'Data Wrangling in Data Analytics?</b></label>
        <textarea style="text-align: center; background-color: rgb(222, 236, 169); width: 90%; height: 300px;" id="comment" type="comment"  name="comment" placeholder="Your answer, additional research may be required on the subject..." required></textarea> 
       <br><br>
  <button  onclick="studyDataAnalyst()" style="float: left;">Previous</button><button onclick="libraryStudy()" style="float: right;">Complete</button>
</div>
<div class="col-md-3 col-lg-3" style="margin: 0px; padding: 0px;"></div>
</div>
</div></div>`
...
function developmentQA() {
  ...
  <div class="row" style="margin: 0px; padding: 0px;">
    <div class="col-md-3 col-lg-3" style="margin: 0px; padding: 0px;"></div>
    <div class="col-md-12 col-lg-6" style="margin: 0px; padding: 0px;">
        <label><b>1) What is the difference between null value and undefined value in JavaScript? What is npm? 2)What is DOM (Document Object Model)? What are CSS selectors? What is the use of float property in CSS?</b></label>
        <textarea style="text-align: center; background-color: rgb(222, 236, 169); width: 90%; height: 300px;" id="comment" type="comment"  name="comment" placeholder="Your answer, additional research may be required on the subject..." required></textarea> 
       <br><br>
  <button  onclick="studyDevelopment()" style="float: left;">Previous</button><button onclick="libraryStudy()" style="float: right;">Complete</button>
</div>
<div class="col-md-3 col-lg-3" style="margin: 0px; padding: 0px;"></div>
</div>
</div></div>`
};
function digitalMarketingQA() {
  document.body.innerHTML = `${libraryNav}<br><br><div style="background-color: white; padding: 30px; border-radius: 30px;><div>
  <h3 style="text-align: center;">If you have the answer consider yourself to have 80% knowlegde on the subject.</h3>
  <br><br>
  <div class="row" style="margin: 0px; padding: 0px;">
    <div class="col-md-3 col-lg-3" style="margin: 0px; padding: 0px;"></div>
    <div class="col-md-12 col-lg-6" style="margin: 0px; padding: 0px;">
        <label><b>1)  Why Should We Invest In Video Content? How Relevant Is SEO In Years To Come? 2)How Can We Utilise Automation In Digital Marketing? Most Important Social Media Marketing Metrics?</b></label>
        <textarea style="text-align: center; background-color: rgb(222, 236, 169); width: 90%; height: 300px;" id="comment" type="comment"  name="comment" placeholder="Your answer, additional research may be required on the subject..." required></textarea> 
       <br><br>
  <button  onclick="studyDigitalMarketing()" style="float: left;">Previous</button><button onclick="libraryStudy()" style="float: right;">Complete</button>
</div>
<div class="col-md-3 col-lg-3" style="margin: 0px; padding: 0px;"></div>
</div>
</div></div>`
...
function englishQA() {
  ...
  <div class="row" style="margin: 0px; padding: 0px;">
    <div class="col-md-3 col-lg-3" style="margin: 0px; padding: 0px;"></div>
    <div class="col-md-12 col-lg-6" style="margin: 0px; padding: 0px;">
        <label><b>1) What is the definition of 'plethora'? What is the definition of 'oratory'? Is Obama a bad, good or excellent orator? 2)Should we read and listen to any kind of texts and speeches?</b></label>
        <textarea style="text-align: center; background-color: rgb(222, 236, 169); width: 90%; height: 300px;" id="comment" type="comment"  name="comment" placeholder="Your answer, additional research may be required on the subject..." required></textarea> 
       <br><br>
  <button  onclick="studyEnglish()" style="float: left;">Previous</button><button onclick="libraryStudy()" style="float: right;">Complete</button>
</div>
<div class="col-md-3 col-lg-3" style="margin: 0px; padding: 0px;"></div>
</div>
</div></div>`
};
function machineLearningQA() {
  document.body.innerHTML = `${libraryNav}<br><br><div style="background-color: white; padding: 30px; border-radius: 30px;><div>
  <h3 style="text-align: center;">If you have the answer consider yourself to have 80% knowlegde on the subject.</h3>
  <br><br>
  <div class="row" style="margin: 0px; padding: 0px;">
    <div class="col-md-3 col-lg-3" style="margin: 0px; padding: 0px;"></div>
    <div class="col-md-12 col-lg-6" style="margin: 0px; padding: 0px;">
        <label><b>Please define these terms: neural networks, overfitting and underfitting, gradient descent, hyperparameters, and reinforcement learning.</b></label>
        <textarea style="text-align: center; background-color: rgb(222, 236, 169); width: 90%; height: 300px;" id="comment" type="comment"  name="comment" placeholder="Your answer, additional research may be required on the subject..." required></textarea> 
       <br><br>
  <button  onclick="studyMachineLearning()" style="float: left;">Previous</button><button onclick="libraryStudy()" style="float: right;">Complete</button>
</div>
<div class="col-md-3 col-lg-3" style="margin: 0px; padding: 0px;"></div>
</div>
</div></div>`
};
function projectManagementQA() {
  document.body.innerHTML = `${libraryNav}<br><br><div style="background-color: white; padding: 30px; border-radius: 30px;><div>
  <h3 style="text-align: center;">If you have the answer consider yourself to have 80% knowlegde on the subject.</h3>
  <br><br>
  <div class="row" style="margin: 0px; padding: 0px;">
    <div class="col-md-3 col-lg-3" style="margin: 0px; padding: 0px;"></div>
    <div class="col-md-12 col-lg-6" style="margin: 0px; padding: 0px;">
        <label><b>1)An accepted deadline for project approaches. However, the project manager realizes only 75% percent of the work has been completed. The project manager then issues a change request. What should the change request authorize? What is meant by RACI?  2)How phases are there in project management? You are the manager of a project which involves constructing five bridges. The project comprises five sequential phases with each phase completing one bridge. After the first phase of the project is complete, which process group of the second phase should follow?</b></label>
        <textarea style="text-align: center; background-color: rgb(222, 236, 169); width: 90%; height: 300px;" id="comment" type="comment"  name="comment" placeholder="Your answer, additional research may be required on the subject..." required></textarea> 
       <br><br>
  <button  onclick="studyProjectManagement()" style="float: left;">Previous</button><button onclick="libraryStudy()" style="float: right;">Complete</button>
</div>
<div class="col-md-3 col-lg-3" style="margin: 0px; padding: 0px;"></div>
</div>
</div></div>`
